...
def modify_bag(in_bag, out_dir, start_time, duration):
...
#	p_obs = percept_obs.PerceptionObstacle()
		...
		x = 587527.658539
		y = 4140717.01327
		p_obs.position.x = 587527.658539
		p_obs.position.y = 4140717.01327
...
if __name__ == "__main__":
    ...
    modify_bag(args.in_rosbag, args.out_dir, args.start_time, args.duration)
